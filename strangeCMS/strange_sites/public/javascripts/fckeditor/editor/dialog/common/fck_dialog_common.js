...
function GetCommonDialogCss( prefix )
{
	...
	return FCKConfig.BasePath + 'dialog/common/' + '|.ImagePreviewArea{border:#000 1px solid;overflow:auto;width:100%;height:170px;background-color:#fff}.FlashPreviewArea{border:#000 1px solid;padding:5px;overflow:auto;width:100%;height:170px;background-color:#fff}.BtnReset{display: inline-block;background-position: center center;background-image: url(images/reset.png);width: 26px;height: 26px;background-repeat: no-repeat;border: solid 1px transparent;font-size: 1px ;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;}.BtnLocked, .BtnUnlocked{display: inline-block;background-position: center center;background-image: url(images/lock.png);width: 26px;height: 26px;background-repeat: no-repeat;border: solid 1px transparent;font-size: 1px ;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;}.BtnUnlocked{background-image: url(images/unlock.png);}.BtnOver{background-color: e6e6e6;border: outset 1px #999;cursor: pointer;}.BtnLocked:hover, .BtnUnlocked:hover, .BtnReset:hover {background-color: e6e6e6;border: outset 1px #999;cursor: pointer;}' ;
}
