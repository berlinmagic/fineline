...
window.onload = function()
{
	...
	GetE('fromServer').style.display				= FCKConfig.ImageBrowser	? '' : '' ;
...
function LoadSelection()
{
	...
	GetE('íStrangeMargin').value = oImage.style.margin ;
	GetE('íStrangePadding').value = oImage.style.padding ;
	GetE('íStrangeborderStyle').value = oImageOriginal.style.borderStyle ;
	GetE('íStrangeborderColor').value = oImageOriginal.style.borderColor ;
	GetE('íStrangeborderWidth').value = oImageOriginal.style.borderWidth ;
...
*/
	e.style.display = '';
	e.style.margin = GetE('íStrangeMargin').value + " " + GetE('íStrangeMargin').value;
	e.style.padding = GetE('íStrangePadding').value + " " + GetE('íStrangePadding').value;
	e.style.borderColor = GetE('íStrangeborderColor').value;
	e.style.borderStyle = GetE('íStrangeborderStyle').value;
	e.style.borderWidth = GetE('íStrangeborderWidth').value;
...
function ResetSizes()
{
	...
	GetE('íStrangeMargin').value = oImageOriginal.style.margin ;
	GetE('íStrangePadding').value = oImageOriginal.style.padding ;
	GetE('íStrangeborderColor').value = oImageOriginal.style.borderColor ;
	GetE('íStrangeborderStyle').value = oImageOriginal.style.borderStyle ;
	GetE('íStrangeborderWidth').value = oImageOriginal.style.borderWidth ;
