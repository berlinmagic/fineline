var strgMap_w 	= 	FCKConfig.StrangeCMS_gMapsBrowserWindowWidth 	|| 	500 ;
var strgMap_h 	= 	FCKConfig.StrangeCMS_gMapsBrowserWindowHeight 	||	600 ;
...
FCKCommands.RegisterCommand( 'googlemaps', new FCKDialogCommand( 'googlemaps', FCKLang.DlgGMapsTitle, FCKPlugins.Items['googlemaps'].Path + 'dialog/googleMaps.html', strgMap_w, strgMap_h ) ) ;
...
var FCKGoogleMap = function() 
{
	...
	this.centerLat = FCKConfig.GoogleMaps_CenterLat || 52.61639 ;
	this.centerLon =  FCKConfig.GoogleMaps_CenterLon || 13.35938 ;
	this.zoom = FCKConfig.GoogleMaps_Zoom || 8 ;
