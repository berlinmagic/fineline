...
std_header = Header.create! :name => 'Standard_Header', :typ => 'fader', :height => 210, :width => 950, :staytime => 5, :changetime => 3, :hintergrund => 'verlauf', :farbe1 => '001f46', :farbe2 => '003366', :system_stuff => true
